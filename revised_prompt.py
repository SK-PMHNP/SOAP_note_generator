        ...
        contents = types.Content(
            parts = [
                ...
                types.Part(text='Generate a SOAP style psychotherapy note based on the contents of the video. Include a Mental Status Examination and Risk Assessment.'
                                ...
                                'If appropriate, include differential diagnoses with a brief description of rationale supporting these diagnoses as per DSM-V criteria.'
                                ''
                                'Header: Plan'
                                'Content: Plan for future evaluation and/or treatment for presenting problem(s).' 
                                'Must include plan for follow up schedule (either ongoing, e.g. "weekly", or for next visit, e.g., "in one week".'
                                'If therapist states during appointment that a specific topic will be discussed in a future appointment, note this.'
                                'If recommendations for diagnostic tests or referrals to other providers are appropriate, note these.'
                                'May include plans for specific therapeutic approaches (e.g., Cognitive Behavioral Therapy, EMDR) to consider in follow up visits if applicable.'
                                ''
